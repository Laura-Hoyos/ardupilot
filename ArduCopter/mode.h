...
public:
    ...
    enum class Number : uint8_t {
        ...
        CUSTOM_Loiter = 27, // Custom Loiter mode using optical flow and Range Finder to aproach to ground without landing
    };
...
class ModeCustomLoiter : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::CUSTOM_LOITER; }
...
protected:
    ...
    const char *name() const override { return "CUSTOM_LOITER"; }
    const char *name4() const override { return "CSTLOIT"; }
